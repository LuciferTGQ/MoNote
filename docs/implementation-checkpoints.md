...
| 12.2. Clear formatting toolbar and practical settings | `952e3c4`, `5dc6d5a` | Replaced the cryptic crowded toolbar with five named common actions plus an advanced “More” menu; added persistent theme, editor font size, auto-save, and default-orientation settings. Fixed the auto-save initialization race found during device verification. 76 renderer tests and production build passed; 179 JVM tests passed with 5 environment skips; 9 focused API 30 editor/settings tests passed; lint reported 0 errors; manual disabled-auto-save and explicit-save verification passed. APK SHA-256: `C36544516611AC0E31AC98B343D7E6D68F74E1C7A96F7384B36A9B545684EEDC` |
